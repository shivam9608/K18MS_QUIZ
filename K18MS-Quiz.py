...
def showresult(score):
    ...
    if score >= 20:
        ...
        labelresulttext.configure(text="Excellent! Answered ALL Questions.")
    elif (score >= 10 and score < 20):
        img = PhotoImage(file="ok.png")
        labelimage.configure(image=img)
        labelimage.image = img
        labelresulttext.configure(text="Can Be Better! Answered MEDIUM questions.")
    else:
        img = PhotoImage(file="bad.png")
        labelimage.configure(image=img)
        labelimage.image = img
        labelresulttext.configure(text="Should Work Hard! Answered EASY questions.")
